...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Mello Mix</title>
        <meta name='description' content='Mello Mix by ProgrammerXD' />
      ...
      <main className={styles.main} id='main' ref={main}>
        ...
        <div className={`${styles.containers} ${styles.cB}`}>
          <h2>Recently Played <span className={styles.playlistTitle}> - Playlist Name : Lofi World🍁✨</span></h2>
          <JumpBackIn sap={searchAndPlay} sapR={sapReturn} />
        </div>


        <div className={`${styles.containers} ${styles.cC}`}>
          <h2>Jump back In <span className={styles.playlistTitle}> - Playlist Name : Vibes✨👀</span></h2>
